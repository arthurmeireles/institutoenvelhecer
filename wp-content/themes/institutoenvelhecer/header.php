        ...
        <div class="collapse navbar-collapse" id="navcol-1">
            <ul class="nav navbar-nav flex-grow-1 justify-content-between">
                <li class="nav-item" role="presentation">
                    <a class="nav-link" href="/institutoenvelhecer/">
                        <img class="logo-header" src="/institutoenvelhecer/wp-content/uploads/2020/04/logo-header.ad41f201.png">
                    </a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" href="/institutoenvelhecer/">Página Inicial</a>
                </li>
                <li class="nav-item" role="presentation">
